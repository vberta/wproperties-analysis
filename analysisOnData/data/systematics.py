systematics = {
    ...
    #"ptScale": (["_zptsystUp", "_zptsystDown", "_EwksystUp", "_EwksystDown", "_deltaMsystUp", "_deltaMsystDown"]+["_stateig{}{}".format(i, v) for i in range(0, 99) for v in ['Up', 'Down']], "rochWeights")
}
