...
RNode getVars::run(RNode d){
  ...
  //auto getPositive = [](float pt1, float pt2, float q1)->float { if(q1>0.) return pt1; return pt2; };
  //auto getNegative = [](float pt1, float pt2, float q1)->float { if(q1<0.) return pt1; return pt2; };
