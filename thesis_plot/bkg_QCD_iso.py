...
legDict = {
    'int': ['25 GeV<p_{T}<55 GeV, |#eta|<2.4',ROOT.kRed+2],
    'pt25' : ['25 GeV<p_{T}<35 GeV, |#eta|<2.4',ROOT.kBlue-4],
    'pt50' : ['45 GeV<p_{T}<55 GeV, |#eta|<2.4',ROOT.kOrange+1],
    'eta2' : ['25 GeV<p_{T}<55 GeV, 1.6<#eta<2.4',ROOT.kGreen+2],
    'eta0' : ['25 GeV<p_{T}<55 GeV, |#eta|<0.4',ROOT.kAzure+9]
}
...
for k,info in legDict.items() :
    ...
    fakeDict[k].GetYaxis().SetRangeUser(0,1)
...
leg = ROOT.TLegend(0.12,0.78,0.4,0.9)
leg.SetFillStyle(0)
leg.SetBorderSize(0)
# leg.SetNColumns(2)
...
legFit = ROOT.TLegend(0.42,0.78,0.8,0.9)
